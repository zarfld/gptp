# Run gptp with Milan profile as Administrator
param()
...
Write-Host "Starting gptp with Milan profile, MAC: $mac" -ForegroundColor Green
...
try {
    Write-Host "Executing: $exePath -Milan $mac -debug-packets" -ForegroundColor Cyan
    Write-Host "Log file: $logFile" -ForegroundColor Cyan
    
    # Run gptp and capture all output
    & $exePath -Milan $mac -debug-packets 2>&1 | Tee-Object -FilePath $logFile
